...
export const defaultHomepageContent: HomepageContent = {
  ...
  "hero": {
    "headlinePrefix": "Your perfect",
    "headlineHighlight": "Riyaz companion",
  ...
  "users": {
    "title": "Who is it For",
    "description": "Designed for passionate musicians across Indian classical traditions",
    "cards": [
      {
        "title": "Tabla & Pakhwaj Players",
        "description": "Master rhythm patterns and taal structures with authentic accompaniment",
        "image": {
  ...
  "features": {
    ...
    "description": "Thoughtfully designed tools for serious classical practice and riyaaz.",
    "cards": [
      {
        "icon": "gauge",
        "title": "BPM Range",
        "description": "Precision tempo settings across an extensive range (30-500 BPM) for metronomic control over rhythmic mastery."
      },
      {
        "icon": "waves",
        "title": "Vocal Nagma",
        "description": "Integrates nuanced vocal accompaniment to deliver an immersive, authentic classical performance."
      },
      {
        "icon": "sparkles",
        "title": "Specially Composed Nagmas",
        "description": "Curated compositions tailored specifically to enhance taal alignment and facilitate seamless practice flows."
      },
      {
        "icon": "library",
        "title": "Vast Library of Raags",
        "description": "Access an unparalleled collection of raags, encompassing diverse emotional landscapes and moods."
      },
      {
        "icon": "clock",
        "title": "Raag Samay Chakra",
        "description": "Align your practice with traditional timing: play raags at their intended prahars as guided by the Samay Chakra."
      },
      {
        "icon": "sliders",
        "title": "In-built Tuner",
        "description": "High-precision instrumentation for flawless tuning, ensuring your instrument achieves optimal tonal pitch and harmony."
      },
      {
        "icon": "mic",
        "title": "Real Sound, Real Feel",
        "description": "Authentic, high-fidelity acoustic performance, professionally mastered in a dedicated studio environment."
      },
      {
        "icon": "barChart",
        "title": "Track Your Progress",
        "description": "Comprehensive analytics dashboard to monitor personal development and benchmark your practice against peer performance data."
      }
    ]
  },
  "userguide": {
    "title": "Grind Your Skills to Perfection",
    "description": "Discover how musicians like you are transforming their practice",
    "cards": [
      {
        "icon": "headphones",
        "title": "Never Practice Alone Again",
        "description": "Experience the joy of real accompaniment anytime at tip of your finger. Record and compose your own nagmas, explore what others have uploaded, and be part of a creative community.",
      ...
      },
      {
        ...
        "description": "Access hundreds of nagmas, composed accordingly to the structure of taals. Build confidence in learning new compositions with precision-tuned accompaniment designed by masters.",
      ...
      },
      {
        ...
        "description": "Build daily practice streaks, monitor your progress, and celebrate milestones in your musical journey. Visual insights help you stay motivated and understand your improvement over time.",
      ...
      },
      {
        ...
        "description": "Specialised accompaniments for different instruments and playing styles. Find precisely what your instrument needs from tabla to harmonium, sarangi to sitar, and everything else.",
    ...
    "items": [
      {
        ...
        "quote": "Nagma Player brings authenticity to digital accompaniment like nothing I've experienced before.",
        "stars": 5
      },
      {
        "name": "Tabla Expert Ritika",
        "role": "International Percussionist",
        "quote": "The precision and musical accuracy are exceptional. My students love practicing with it.",
        "stars": 5
      },
      {
        "name": "Smita Devi",
        "role": "Kathak Dancer & Musician",
        "quote": "Finally, a tool that truly understands classical music. Highly recommended for any serious artist.",
        "stars": 5
      }
    ]
  },
  ...
  "cta": {
    ...
    "description": "Join thousands of musicians elevating their classical artistry with Nagma Player Premium",
    "storeButtons": [
      {
        "href": "#",
        "icon": "apple",
